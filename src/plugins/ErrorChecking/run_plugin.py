"""
This script is called by the plugin-wrapper, ErrorChecking.js, which passes down the
...
plugin = ErrorChecking(webgme, COMMIT_HASH, BRANCH_NAME, ACTIVE_NODE_PATH, ACTIVE_SELECTION_PATHS, NAMESPACE)
